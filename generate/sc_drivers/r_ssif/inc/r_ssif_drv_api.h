 ...
 * @brief          Header file for R_SSIF_DRV_API Driver
 * @version        1.00
 * @date           27.06.2018
...
/**************************************************************************//**
 * @ingroup R_SW_PKG_246_POSIX_Drivers
 * @defgroup R_SW_PKG_246_SSIF_API SSIF Driver
 * @brief This interface provides access to the Serial Sound Interface SSIF
 * peripheral.
 * @anchor R_SW_PKG_246_SSIF_API_SUMMARY
 * @par Summary
 ...
 *
 * @anchor R_SW_PKG_246_SSIF_API_LIMITATIONS
 * @par Known Limitations
 * @ref NONE_YET
 *
 * @anchor R_SW_PKG_246_SSIF_API_INSTANCES
 * @par Known Implementations:
 * This driver is used in the RZA2M Software Package.
 * @ref RENESAS_APPLICATION_SOFTWARE_PACKAGE
 *
 * @ref R_SW_PKG_246_SOUND_APP
 * @{
 *****************************************************************************/
 ...
 * \c ssif_hld_open - Opens the SSIF Driver <BR>
 * \c ssif_hld_close - Closes the SSIF Driver <BR>
 * \c ssif_hld_read - Reads from the SSIF Peripheral <BR>
 * \c ssif_hld_write - Writes to the SSIF Peripheral <BR>
 * \c ssif_hld_control - see @ref e_control_codes_ssif_t for commands<BR>
 * Supported:<BR>
 * \arg \b CTL_SSIF_CONTROL_CONFIGURE Configure SSIF, uses parameter @ref st_r_ssif_drv_control_t <BR>
 ...
 *
 * \c ssif_hld_get_version - Get driver version<BR>
 */
 ...
 * Updated by product owner */
    #define R_SSIF_RZ_HLD_VERSION_MAJOR      (1)
 ...
 * Generated during customer release */
    #define R_SSIF_RZ_HLD_BUILD_NUM          (0)

/** Unique ID. Assigned by requirements */
    #define R_SSIF_RZ_HLD_UID                (245)

/* Control Codes */
/** Control codes for SSIF Driver */
typedef enum
{
    CTL_SSIF_SET_CONFIGURE = 0,   /*!< Configure SSIF, uses parameter @ref st_r_ssif_drv_control_t */
    CTL_SSIF_CANCEL,
    CTL_SSIF_GET_STATUS,              /*!< Report SSIF status, uses parameter @ref st_r_ssif_drv_control_t */
    CTL_SSIF_READ,                /*!< Configure SSIF to read, uses parameter @ref aiocb */
    CTL_SSIF_WRITE                /*!< Configure SSIF to write, uses parameter @ref aiocb */
...
typedef int16_t r_ssif_index_t;
