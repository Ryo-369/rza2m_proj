...
/*******************************************************************************
 End of function R_SSIF_Userdef_InitPinMux
 ******************************************************************************/
...
int_t R_SSIF_Userdef_SetClockDiv(const ssif_channel_cfg_t* const p_ch_cfg, ssif_chcfg_ckdv_t* const p_clk_div)
{
    ...
    else
    {
        ...
        {
            input_clk = RENESAS_RZ_A2_AUDIO_X1;
        }
        else if (SSIF_CFG_CKS_AUDIO_CLK == p_ch_cfg->clk_select)
        {
            input_clk = RENESAS_RZ_A2_AUDIO_CLK;
        }
        else
        {
            input_clk = 0u;
        ...
        if (IOIF_ESUCCESS == ret)
        {
            ...
            else
            {
                ...
                n_syswd_per_smp = (((uint32_t)p_ch_cfg->frame_word) + 1) * SSIF_I2S_LR_CH;
            }
...
/*******************************************************************************
 End of function R_SSIF_Userdef_SetClockDiv
 ******************************************************************************/
