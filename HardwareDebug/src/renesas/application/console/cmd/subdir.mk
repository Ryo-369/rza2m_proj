...
C_SRCS += \
../src/renesas/application/console/cmd/cmd_sound_app.c 

LST += \
cmd_sound_app.lst 

C_DEPS += \
./src/renesas/application/console/cmd/cmd_sound_app.d 

OBJS += \
./src/renesas/application/console/cmd/cmd_sound_app.o 
...
src/renesas/application/console/cmd/%.o: ../src/renesas/application/console/cmd/%.c
	@echo 'Building file: $<'
